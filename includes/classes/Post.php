    ...
    $('#post<?php echo $id; ?>').on('click', function() {
      bootbox.confirm("Are you sure you want to delete this post?", function(result) {
        $.post("includes/form_handlers/delete_post.php?post_id=<?php echo $id; ?>", { result: result })
          .done(function() {
            window.location.href = "<?php echo $_SERVER['HTTP_REFERER']; ?>"; // Redirect to the previous URL
          })
          .fail(function() {
...
<script>
  function editPost(postId) {
    // Prompt the user for the edited post content
    var editedPost = prompt("Enter your edited post:");

    // Make an AJAX request to update the post in the database
    if (editedPost != null && editedPost.trim() != "") {
      $.post("includes/form_handlers/edit_post.php", { post_id: postId, edited_post: editedPost })
        .done(function() {
